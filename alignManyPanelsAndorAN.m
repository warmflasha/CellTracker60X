function [acoords, fullIm]=alignManyPanelsAndorAN(direc,imKeyWord,dir1,dir2,dims,parrange,maxims)
...
filename = getAndorFileName(ff,pos,ff.t(img),ff.z(zplane),chan(2));
