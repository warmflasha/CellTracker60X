function [mrnapercell] = mrnapercell3d(nucleilist, stats, mrnamatfile)
...
load(mrnamatfile);
spots = spotinfomat(spotinfomat(:,1) == 1,:);
...
%     z0 = spotspos(i,3);
%     
    x0 = s1(cellmatch2(i),3);
    y0 = s1(cellmatch2(i),4);
    z0 = s1(cellmatch2(i),2);
