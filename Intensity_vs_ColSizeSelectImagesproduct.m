function [rawdata1,totalcells] =  Intensity_vs_ColSizeSelectImagesproduct(nms,nms2,dir,index1,param1,dapimax,chanmax,usemeandapi,flag,imN)
...
for k=1:size(nms,2)
    ...
    rawdata1{k} = rawdata;
    totalcells(1:8,k) = totalcells(1:8);
end
end