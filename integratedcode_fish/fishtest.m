...
%         
     ...
     for k = 0:imch  % Saving imagefiles to the output variable
         Imgfiles{m}{k+1} = andorMaxIntensity(ff, i, 0, k);
     end
      m = m+1;
     end
end
...
%%
n_ch = [3]; % Channels that are analysed and need to be tabulated. List out all the channels that need to be tabulated.
sn = 2;
%dir1 = pwd;

tabulatemRNAposfish(dir1, sn, n_ch, Imgfiles);
...
title('Lefty Channel mRNAs identified', 'FontWeight', 'Bold');
